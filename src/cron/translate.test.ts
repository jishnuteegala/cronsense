...
describe("translate", () => {
  ...
  it("month range", () => {
    expect(sentence("0 12 1 3-5 *")).toBe("At 12:00 UTC, on day-of-month 1, in March through May.");
  });
  ...
  it("list of days of week", () => {
    expect(sentence("0 6 * * 1,3,5")).toBe("At 06:00 UTC, on Monday, Wednesday, and Friday.");
  });
